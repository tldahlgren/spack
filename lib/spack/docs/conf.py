...
language = os.environ.get('SPACK_DOC_LANGUAGE')

# If the language variable is set, we're in the localized docs repository,
# and we should use the .po files there to build a translation of the docs.
